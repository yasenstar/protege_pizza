...
- [14.13 Common Mistakes in Restriction Modeling](#1413-common-mistakes-in-restriction-modeling)
  ...
  - [14.3.3 Forgetting the Difference Between `EquivalentTo` and `SubClassOf`](#1433-forgetting-the-difference-between-equivalentto-and-subclassof)
...
### 14.3.3 Forgetting the Difference Between `EquivalentTo` and `SubClassOf`
