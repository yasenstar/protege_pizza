...
- [15.3 Implementing `some` and `only` in Graph Database - A Neo4j Perspective](#153-implementing-some-and-only-in-graph-database---a-neo4j-perspective)
  ...
  - [15.3.4 Cypher Query vs. Pellet Reasoner vs. Open World Assumption](#1534-cypher-query-vs-pellet-reasoner-vs-open-world-assumption)
      ...
      - [Summary: The Logical Bridge Between Sections 15.3.1~15.3.3 and True OWL Reasoning](#summary-the-logical-bridge-between-sections-15311533-and-true-owl-reasoning)
- [Chapter 15 -\> 16 Bridge](#chapter-15---16-bridge)
- [Key Concepts (Chapter 15)](#key-concepts-chapter-15)
- [Protégé Skills Learned (Chapter 15)](#protégé-skills-learned-chapter-15)
- [Next Chapter (16) Preview](#next-chapter-16-preview)
...
![ch15_01_universal-only](img/ch15_01_universal-only.png)
...
![ch15_02_hasTopping-only-PizzaTopping](img/ch15_02_hasTopping-only-PizzaTopping.png)

![ch15_03_hasTopping-only-PizzaTopping-result](img/ch15_03_hasTopping-only-PizzaTopping-result.png)
...
![ch15_04_strangepizza](img/ch15_04_strangepizza.png)
...
![ch15_05_chocolatebar](img/ch15_05_chocolatebar.png)

Now connect them through `StrangePizza hasTopping ChocolateBar` relationship:

![ch15_06_strangepizza-to-chocolatebar](img/ch15_06_strangepizza-to-chocolatebar.png)
...
![ch15_07_vegpizza-combine](img/ch15_07_vegpizza-combine.png)
...
![ch15_08_neo4j-pizza-relation-topping](img/ch15_08_neo4j-pizza-relation-topping.png)
...
![ch15_09_neo4j-mypizza](img/ch15_09_neo4j-mypizza.png)
...
![ch15_10_neo4j-vegetabletopping](img/ch15_10_neo4j-vegetabletopping.png)

Now, you may execute previous Cypher query, and get result `MyPizza`:

![ch15_11_neo4j-exists](img/ch15_11_neo4j-exists.png)
...
![ch15_12_neo4j-universal](img/ch15_12_neo4j-universal.png)
...
![ch15_13_neo4j-some-only](img/ch15_13_neo4j-some-only.png)
...
![ch15_14_pizza-14.10.4](img/ch15_14_pizza-14.10.4.png)
...
![ch15_15_neo4j-14.10.4](img/ch15_15_neo4j-14.10.4.png)
...
![ch15_16_neo4j-14.10.4-add-hierarchy](img/ch15_16_neo4j-14.10.4-add-hierarchy.png)
...
Last updated at: 2026-08-09 (correct images links)