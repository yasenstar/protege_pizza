...
Table of Contents:
- [16.1 EKA Perspective -- Restriction as Semantic Governance](#161-eka-perspective----restriction-as-semantic-governance)
  - [16.1.1 Restriction and the Knowledge Graph Layer ($K$)](#1611-restriction-and-the-knowledge-graph-layer-k)
  - [16.1.2 Restriction and the Reasoning & Rules Layer ($R$)](#1612-restriction-and-the-reasoning--rules-layer-r)
  - [16.1.3 Restriction and the Trigger Layer ($\Theta$)](#1613-restriction-and-the-trigger-layer-theta)
  - [16.1.4 Restriction and the Execution Layer ($\Phi$)](#1614-restriction-and-the-execution-layer-phi)
  - [16.1.5 Restriction and the Governance Layer ($\Gamma$)](#1615-restriction-and-the-governance-layer-gamma)
  - [16.1.6 Restriction as the Foundation of Executable Intelligence](#1616-restriction-as-the-foundation-of-executable-intelligence)
- [16.2 EKA Learning Progression Across Chapters](#162-eka-learning-progression-across-chapters)
  - [16.2.1 A Milestone Worth Recognition](#1621-a-milestone-worth-recognition)
  - [16.2.2 Before Your Move Forward: A Quick Self-Assessment](#1622-before-your-move-forward-a-quick-self-assessment)
  - [16.2.3 From Ontology Learning to Executable Knowledge Architecture](#1623-from-ontology-learning-to-executable-knowledge-architecture)
  - [16.2.4 EKA Tuple Mapping Across Chapters](#1624-eka-tuple-mapping-across-chapters)
- [16.3 Common Mistakes in Restriction Modeling](#163-common-mistakes-in-restriction-modeling)
  - [16.3.1 Confusing `some` with `only`](#1631-confusing-some-with-only)
  - [16.3.2 Assuming Closed World Behavior](#1632-assuming-closed-world-behavior)
  - [16.3.3 Forgetting the Difference Between `EquivalentTo` and `SubClassOf`](#1633-forgetting-the-difference-between-equivalentto-and-subclassof)
  - [16.3.4 Misunderstanding Governance vs Validation -- OWL vs SHACL](#1634-misunderstanding-governance-vs-validation----owl-vs-shacl)
  - [16.3.5 Overusing Restrictions](#1635-overusing-restrictions)
  - [16.3.6 Enterprise Architecture Perspective -- Why These Mistakes Matter](#1636-enterprise-architecture-perspective----why-these-mistakes-matter)
- [16.4 Chapter Summary](#164-chapter-summary)
  - [16.4.1 What We Learned](#1641-what-we-learned)
  - [16.4.2 Why Restrictions Matter](#1642-why-restrictions-matter)
  - [16.4.3 The Semantic Shift](#1643-the-semantic-shift)
- [16.5 Key Concepts](#165-key-concepts)
- [16.6 Protégé Skills Checklist](#166-protégé-skills-checklist)
- [16.7 Looking Ahead -- Creating Subclasses](#167-looking-ahead----creating-subclasses)
  - [16.7.1 Why Subclasses Matter](#1671-why-subclasses-matter)
  - [16.7.2 Restriction and Hierarchy Together](#1672-restriction-and-hierarchy-together)
  - [16.7.3 Preview of Exercise 14](#1673-preview-of-exercise-14)
