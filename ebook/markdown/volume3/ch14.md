...
- [Chapter 14 -\> 15 Bridge](#chapter-14---15-bridge)
- [Key Concepts (Chapter 14)](#key-concepts-chapter-14)
- [Protégé Skills Learned (Chapter 14)](#protégé-skills-learned-chapter-14)
- [Next Chapter (15) Preview](#next-chapter-15-preview)
...
> `hasTopping` connects "Pizza $\to$ PizzaTopping".
...
| Existential Restriction (`some`) | Requires that *at least one* relationship of a given property/class combination exists. |
...
## Protégé Skills Learned (Chapter 14)
