...
At present, the ontology understands that a `MargheritaPizza` is a specialized type of `NamedPizza`, but it does not yet understand ***why*** it is a Margherita pizza. The hierarchy 
