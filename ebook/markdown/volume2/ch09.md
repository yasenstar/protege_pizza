...
- [9.10 Key Concepts](#910-key-concepts)
- [9.11 Protégé Skills Learned](#911-protégé-skills-learned)
- [9.12 Next Chapter (10) Preview](#912-next-chapter-10-preview)

## Chapter Introduction

After stepping beneath Protégé's interface in [Chapter 08](ch08.md) to understand RDF as the underlying language of semantic representation, we now return to practical ontology engineering with renewed perspective.
...
<h3>Mistake 2 -- Overly Flat Structures</h3>
...
<h3>Mistake 4 -- Ignoring Future Scalability</h3>
