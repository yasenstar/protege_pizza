...
- [17.12 EKA Perspective -- Stage 2 Enriches the Knowledge Layer $K$ and Prepares Reasoning $R$](#1712-eka-perspective----stage-2-enriches-the-knowledge-layer-k-and-prepares-reasoning-r)
- [17.13 Engineering Guidelines for Semantic Description](#1713-engineering-guidelines-for-semantic-description)
  - [17.13.1 Model Meaning Incrementally](#17131-model-meaning-incrementally)
  - [17.13.2 Prefer Necessary Conditions Before Complete Definitions](#17132-prefer-necessary-conditions-before-complete-definitions)
  - [17.13.3 Write Readable Class Expressions](#17133-write-readable-class-expressions)
  - [17.13.4 Reuse Semantic Patterns](#17134-reuse-semantic-patterns)
  - [17.13.5 Validate Frequently with the Reasoner](#17135-validate-frequently-with-the-reasoner)
  - [17.13.6 Avoid Over-Constraining Early Models](#17136-avoid-over-constraining-early-models)
  - [17.13.7 Separate Conceptual Organization from Semantic Description](#17137-separate-conceptual-organization-from-semantic-description)
  - [17.13.8 Engineering Takeaway](#17138-engineering-takeaway)
...
## 17.12 EKA Perspective -- Stage 2 Enriches the Knowledge Layer $K$ and Prepares Reasoning $R$
...
### 17.13.1 Model Meaning Incrementally
...
### 17.13.2 Prefer Necessary Conditions Before Complete Definitions
...
### 17.13.3 Write Readable Class Expressions
...
### 17.13.4 Reuse Semantic Patterns
...
### 17.13.5 Validate Frequently with the Reasoner
...
### 17.13.6 Avoid Over-Constraining Early Models
...
### 17.13.7 Separate Conceptual Organization from Semantic Description
