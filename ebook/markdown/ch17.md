...
| Chapter | Tutorial Exercise | SKDL Stage | Engineering Focus |
| :---: | :---: | --- | --- |
| 18 | Exercise 14 | Conceptual Modeling | Build semantic taxonomies through classes and subclass hierarchies. |
| 19 | Exercise 15 | Semantic Description | Enrich concepts with formal semantic definitions and logical restrictions. |
| 20 | Exercise 16 | Knowledge Reuse | Reuse and refine semantic patterns through incremental ontology development. |
| 21 | Exercise 17-18 | Semantic Governance | Improve semantic quality through disciplined ontology engineering practices. |
| 22 | Exercise 19 | Semantic Validation | Verify logical consistency and semantic correctness using OWL reasoning. |
| 23 | Exercise 20 | Semantic Reasoning | Discover implicit knowledge through automated inference and semantic classification. |
| | Later Chapters | Executable Knowledge | Extend semantic models into knowledge graphs, EKA, automation, and AI-driven applications. |
...
Last updated at 2026-08-08, renamed from original Chapter 15