...
Unlike the subclass relationships introduced in Chapter (16), which organized concepts into a conceptual taxonomy, existential restrictions begin describing the characteristics that distinguish one concept fro another.
...
| --- | --- |
| `some` | At lease one related individual satisfies the condition. |
