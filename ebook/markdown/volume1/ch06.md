...
- [6.9 Chapter (06) Summary](#69-chapter-06-summary)
- [6.10 Key Concepts](#610-key-concepts)
- [6.11 Protégé Skills Learned](#611-protégé-skills-learned)
- [6.12 Next Chapter (07) Preview](#612-next-chapter-07-preview)
- [6.13 Demo Video for this Chapter (06)](#613-demo-video-for-this-chapter-06)
...
Objective: we will have one pizza instance under `VegetarianPizza` subclass and let it contain a `MeatTopping`, and that should trigger inconsistency warning with the rule `VegetarianPizza` should only contain `CheeseTopping` or `VegetableToppings`.
...
4. In tab `Class expression editor`, write down the rule `Pizza and (hasTopping only (CheeseTopping or VegetableTopping))`
5. Click `OK`
...
## 6.13 Demo Video for this Chapter (06)
