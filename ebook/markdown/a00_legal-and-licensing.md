...
For further details regarding the full attribution chain, the history of this project, or the specific licensing of individual files, please refer to the [README.md](../README.md) and [LICENSE.md](../LICENSE.md) files in the [official GitHub repository](https://github.com/yasenstar/protege_pizza) (https://github.com/yasenstar/protege_pizza).
