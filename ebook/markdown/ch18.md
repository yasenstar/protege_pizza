...
- [18.3 Exercise 16 -- Reusing Semantic Knowledge in Practice](#183-exercise-16----reusing-semantic-knowledge-in-practice)
  - [18.3.1 Engineering Objective of Exercise 16](#1831-engineering-objective-of-exercise-16)
  - [18.3.2 From Copying Classes to Reusing Knowledge](#1832-from-copying-classes-to-reusing-knowledge)
  - [18.3.3 Reuse Before Redesign](#1833-reuse-before-redesign)
  - [18.3.4 Knowledge Reuse versus Knowledge Duplication](#1834-knowledge-reuse-versus-knowledge-duplication)
  - [18.3.5 Looking Beyond the User Interface](#1835-looking-beyond-the-user-interface)
- [18.4 Clone Before Create -- Reuse as an Engineering Pattern](#184-clone-before-create----reuse-as-an-engineering-pattern)
  - [18.4.1 The Pattern in Software Engineering](#1841-the-pattern-in-software-engineering)
  - [18.4.2 The Pattern in Enterprise Architecture](#1842-the-pattern-in-enterprise-architecture)
  - [18.4.3 The Pattern in Design and Manufacturing](#1843-the-pattern-in-design-and-manufacturing)
  - [18.4.4 From Copying to Knowledge Reuse](#1844-from-copying-to-knowledge-reuse)
  - [18.4.5 The Role of Variation in Knowledge Reuse](#1845-the-role-of-variation-in-knowledge-reuse)
  - [18.4.6 The Limits of Cloning](#1846-the-limits-of-cloning)
  - [18.4.7 The Engineering Attitude](#1847-the-engineering-attitude)
- [18.5 Reusable Semantic Patterns in OWL](#185-reusable-semantic-patterns-in-owl)
  - [18.5.1 Inheritance (`SubClassOf`)](#1851-inheritance-subclassof)
  - [18.5.2 Equivalent Class Definitions (`EquivalentTo`)](#1852-equivalent-class-definitions-equivalentto)
  - [18.5.3 Reusable Restriction Patterns](#1853-reusable-restriction-patterns)
  - [18.5.4 Ontology Imports (`owl:imports`)](#1854-ontology-imports-owlimports)
  - [18.5.5 Design Patterns](#1855-design-patterns)
  - [18.5.6 Semantic Alignment](#1856-semantic-alignment)
- [18.6 Reuse Across Disciplines - Mechanisms](#186-reuse-across-disciplines---mechanisms)
  - [18.6.1 Software Engineering -- Inheritance and Composition](#1861-software-engineering----inheritance-and-composition)
  - [18.6.2 Enterprise Architecture -- Capability Reuse and Reference Architecture](#1862-enterprise-architecture----capability-reuse-and-reference-architecture)
  - [18.6.3 Scientific Research -- Citation and Systematic Review](#1863-scientific-research----citation-and-systematic-review)
  - [18.6.4 Biology -- Gene Duplication and Regulatory Review](#1864-biology----gene-duplication-and-regulatory-review)
  - [18.6.5 Artificial Intelligence -- Transfer Learning and Model Adaptation](#1865-artificial-intelligence----transfer-learning-and-model-adaptation)
- [18.7 Mathematical Perspective -- Abstraction, Generalization and Reuse](#187-mathematical-perspective----abstraction-generalization-and-reuse)
  - [18.7.1 Generalization as Subset Inclusion](#1871-generalization-as-subset-inclusion)
  - [18.7.2 Abstraction and Dimension Reduction](#1872-abstraction-and-dimension-reduction)
  - [18.7.3 Posets and Lattices](#1873-posets-and-lattices)
  - [18.7.4 Reuse and Logical Consistency](#1874-reuse-and-logical-consistency)
- [18.9 Interesting Reading -- From Plato to Design Patterns](#189-interesting-reading----from-plato-to-design-patterns)
- [18.10 EKA Perspective -- Stage 3 Strengthens $K$ and Prepares $\\Gamma$](#1810-eka-perspective----stage-3-strengthens-k-and-prepares-gamma)
- [18.11 Engineering Guidelines for Knowledge Reuse](#1811-engineering-guidelines-for-knowledge-reuse)
- [18.12 Key Concepts](#1812-key-concepts)
- [18.13 Chapter Summary](#1813-chapter-summary)
- [18.14 Looking Ahead -- Knowledge Governance](#1814-looking-ahead----knowledge-governance)
...
## 18.3 Exercise 16 -- Reusing Semantic Knowledge in Practice
...
### 18.3.1 Engineering Objective of Exercise 16
...
### 18.3.2 From Copying Classes to Reusing Knowledge
...
![ch18_01_class-duplicate-right-click](img/ch18_01_class-duplicate-right-click.png)
...
![ch18_02_duplicate-class-dialogue](img/ch18_02_duplicate-class-dialogue.png)

to:

![ch18_03_duplicate-class-changename](img/ch18_03_duplicate-class-changename.png)

> Notice: when you change `Name`, the IRI identifier is also changed.

After clicking `OK`, new named pizza is added:

![ch18_04_americanapizza](img/ch18_04_americanapizza.png)
...
![ch18_05_americanapizza-subclassof](img/ch18_05_americanapizza-subclassof.png)
...
![ch18_06_add-pepperonitopping](img/ch18_06_add-pepperonitopping.png)

After `PepperoniTopping` is added, you should see below:

![ch18_07_add-pepperonitopping-classexpression](img/ch18_07_add-pepperonitopping-classexpression.png)

Also modifying comment annotation, then the end state of **Exercise 16** should be like below:

![ch18_08_final-americanapizza](img/ch18_08_final-americanapizza.png)
...
### 18.3.4 Knowledge Reuse versus Knowledge Duplication
...
### 18.3.5 Looking Beyond the User Interface
...
## 18.4 Clone Before Create -- Reuse as an Engineering Pattern

The simple act of duplicating `MargheritaPizza` to create `AmericanaPizza` in **Exercise 16** illustrates a much broader engineering principle that extends far beyond Protégé  or OWL.

### 18.4.1 The Pattern in Software Engineering

### 18.4.2 The Pattern in Enterprise Architecture

### 18.4.3 The Pattern in Design and Manufacturing

### 18.4.4 From Copying to Knowledge Reuse

### 18.4.5 The Role of Variation in Knowledge Reuse

### 18.4.6 The Limits of Cloning

### 18.4.7 The Engineering Attitude

## 18.5 Reusable Semantic Patterns in OWL

### 18.5.1 Inheritance (`SubClassOf`)

### 18.5.2 Equivalent Class Definitions (`EquivalentTo`)

### 18.5.3 Reusable Restriction Patterns

### 18.5.4 Ontology Imports (`owl:imports`)

### 18.5.5 Design Patterns

### 18.5.6 Semantic Alignment

## 18.6 Reuse Across Disciplines - Mechanisms

### 18.6.1 Software Engineering -- Inheritance and Composition

### 18.6.2 Enterprise Architecture -- Capability Reuse and Reference Architecture

### 18.6.3 Scientific Research -- Citation and Systematic Review

### 18.6.4 Biology -- Gene Duplication and Regulatory Review

### 18.6.5 Artificial Intelligence -- Transfer Learning and Model Adaptation

## 18.7 Mathematical Perspective -- Abstraction, Generalization and Reuse

### 18.7.1 Generalization as Subset Inclusion

### 18.7.2 Abstraction and Dimension Reduction

### 18.7.3 Posets and Lattices

### 18.7.4 Reuse and Logical Consistency

## 18.9 Interesting Reading -- From Plato to Design Patterns

## 18.10 EKA Perspective -- Stage 3 Strengthens $K$ and Prepares $\Gamma$

## 18.11 Engineering Guidelines for Knowledge Reuse

## 18.12 Key Concepts

## 18.13 Chapter Summary

## 18.14 Looking Ahead -- Knowledge Governance
