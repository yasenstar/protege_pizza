# Chapter 18 -- Conceptual Modeling: Stage 1 of the Semantic Knowledge Development Lifecycle

**Building Semantic Taxonomies Through Subclass Hierarchies**

- [18.1 Introduction -- Conceptual Modeling: The Foundation of Semantic Knowledge](#181-introduction----conceptual-modeling-the-foundation-of-semantic-knowledge)
- [18.2 Learning Objectives](#182-learning-objectives)
- [18.3 Position Within the Semantic Knowledge Development Lifecycle](#183-position-within-the-semantic-knowledge-development-lifecycle)
- [18.4 Exercise 14 -- Creating the First Conceptual Hierarchy](#184-exercise-14----creating-the-first-conceptual-hierarchy)
  - [18.4.1 `Pizza` -- The General Concept](#1841-pizza----the-general-concept)
  - [18.4.2 `NamedPizza` -- Introducing an Intermediate Abstraction](#1842-namedpizza----introducing-an-intermediate-abstraction)
  - [18.4.3 `MargheritaPizza` -- The First Concrete Domain Concept](#1843-margheritapizza----the-first-concrete-domain-concept)
  - [18.4.4 An Engineering Perspective](#1844-an-engineering-perspective)
- [18.5 Why Conceptual Modeling Comes Before Semantic Modeling](#185-why-conceptual-modeling-comes-before-semantic-modeling)
  - [18.5.1 Concept Identification Before Semantic Definition](#1851-concept-identification-before-semantic-definition)
  - [18.5.2 The Engineering Pattern Across Disciplines](#1852-the-engineering-pattern-across-disciplines)
  - [18.5.3 Why Modeling Semantics Too Early Creates Problems](#1853-why-modeling-semantics-too-early-creates-problems)
  - [18.5.4 Conceptual Modeling as the Foundation of EKA Knowledge](#1854-conceptual-modeling-as-the-foundation-of-eka-knowledge)
  - [18.5.5 From Structure to Meaning](#1855-from-structure-to-meaning)
- [18.6 Building a Semantic Taxonomy](#186-building-a-semantic-taxonomy)
  - [18.6.1 Generalization and Specialization](#1861-generalization-and-specialization)
  - [18.6.2 Designing for Semantic Growth](#1862-designing-for-semantic-growth)
  - [18.6.3 More Than Classification](#1863-more-than-classification)
  - [18.6.4 The Conceptual Backbone of Semantic Knowledge](#1864-the-conceptual-backbone-of-semantic-knowledge)
- [18.7 From Taxonomy to Semantic Inheritance](#187-from-taxonomy-to-semantic-inheritance)
  - [18.7.1 From Organization to Meaning](#1871-from-organization-to-meaning)
  - [18.7.2 The Meaning of `SubClassOf`](#1872-the-meaning-of-subclassof)
  - [18.7.3 Semantic Inheritance in Practice](#1873-semantic-inheritance-in-practice)
  - [18.7.4 Semantic Inheritance Is Not Software Inheritance](#1874-semantic-inheritance-is-not-software-inheritance)
  - [18.7.5 Why Semantic Inheritance Matters](#1875-why-semantic-inheritance-matters)
  - [18.7.6 From Conceptual Hierarchies to Logical Reasoning](#1876-from-conceptual-hierarchies-to-logical-reasoning)
- [18.8 Interesting Reading -- Mathematical Foundations of Semantic Taxonomy](#188-interesting-reading----mathematical-foundations-of-semantic-taxonomy)
  - [18.8.1 Classes as Sets](#1881-classes-as-sets)
  - [18.8.2 Why Inheritance Happens Automatically](#1882-why-inheritance-happens-automatically)
  - [18.8.3 A Taxonomy as a *Partially Ordered Set*](#1883-a-taxonomy-as-a-partially-ordered-set)
  - [18.8.4 Why Ontology Engineers Should Care](#1884-why-ontology-engineers-should-care)
  - [18.8.5 Transition](#1885-transition)
- [18.9 Engineering Perspective -- Modeling Before Meaning](#189-engineering-perspective----modeling-before-meaning)
  - [18.9.1 Separating Conceptual Structure from Semantic Meaning](#1891-separating-conceptual-structure-from-semantic-meaning)
  - [18.9.2 Exercise 14 as an Engineering Case Study](#1892-exercise-14-as-an-engineering-case-study)
  - [18.9.3 Engineering Before Implementation](#1893-engineering-before-implementation)
  - [18.9.4 The Role of the Semantic Knowledge Development Lifecycle](#1894-the-role-of-the-semantic-knowledge-development-lifecycle)
  - [18.9.5 Why Incremental Modeling Matters](#1895-why-incremental-modeling-matters)
  - [18.9.6 Engineering Perspective](#1896-engineering-perspective)
  - [18.9.7 Transition to the Next Perspective](#1897-transition-to-the-next-perspective)
- [18.10 Interesting Reading -- Two Great Classification Traditions](#1810-interesting-reading----two-great-classification-traditions)
  - [18.10.1 Biological Taxonomy: Nature's Original Ontology](#18101-biological-taxonomy-natures-original-ontology)
    - [18.10.1.1 Linnaean Classification System](#181011-linnaean-classification-system)
    - [18.10.1.2 Biological Taxonomy and the `Pizza` Ontology](#181012-biological-taxonomy-and-the-pizza-ontology)
    - [18.10.1.3 From Classification to Ontology Engineering](#181013-from-classification-to-ontology-engineering)
  - [18.10.2 Library Classification: Organizing Human Knowledge](#18102-library-classification-organizing-human-knowledge)
    - [18.10.2.1 Dewey Decimal Classification](#181021-dewey-decimal-classification)
    - [18.10.2.2 Library of Congress Classification](#181022-library-of-congress-classification)
    - [18.10.2.3 Library Classification and Ontology Engineering](#181023-library-classification-and-ontology-engineering)
  - [18.10.3 What Both Traditions Teach Ontology Engineers](#18103-what-both-traditions-teach-ontology-engineers)
- [18.11 EKA Perspective -- Conceptual Modeling Establishes the Knowledge Layer ($K$)](#1811-eka-perspective----conceptual-modeling-establishes-the-knowledge-layer-k)
  - [18.11.1 Conceptual Modeling and the EKA Tuple](#18111-conceptual-modeling-and-the-eka-tuple)
  - [18.11.2 Mapping Chapter 18 to the EKA Framework](#18112-mapping-chapter-18-to-the-eka-framework)
  - [18.11.3 Why the Knowledge Layer Comes First](#18113-why-the-knowledge-layer-comes-first)
  - [18.11.4 From Conceptual Organization to Executable Knowledge](#18114-from-conceptual-organization-to-executable-knowledge)
  - [18.11.5 An Architectural Perspective](#18115-an-architectural-perspective)
  - [18.11.6 Engineering Takeaway](#18116-engineering-takeaway)
- [18.12 Engineering Guidelines for Conceptual Modeling](#1812-engineering-guidelines-for-conceptual-modeling)
  - [18.12.1 Think Semantically Rather Than Visually](#18121-think-semantically-rather-than-visually)
  - [18.12.2 Model Concepts Before Properties](#18122-model-concepts-before-properties)
  - [18.12.3 Prefer Generalization Before Duplication](#18123-prefer-generalization-before-duplication)
  - [18.12.4 Design for Future Growth](#18124-design-for-future-growth)
  - [18.12.5 Maintain Consistent Levels of Abstraction](#18125-maintain-consistent-levels-of-abstraction)
  - [18.12.6 Distinguish Classes from Individuals](#18126-distinguish-classes-from-individuals)
  - [18.12.7 Building Stable Taxonomies Before Introducing Semantics](#18127-building-stable-taxonomies-before-introducing-semantics)
  - [18.12.8 Engineering Takeaway](#18128-engineering-takeaway)
- [18.13 Key Concepts](#1813-key-concepts)
- [18.14 Chapter Summary](#1814-chapter-summary)
- [18.15 Looking Ahead -- From Concepts to Meaning](#1815-looking-ahead----from-concepts-to-meaning)

## 18.1 Introduction -- Conceptual Modeling: The Foundation of Semantic Knowledge
...
As introduced in Chapter (17), the **Semantic Knowledge Development Lifecycle (SKDL)** provides a structured engineering methodology for developing semantic knowledge systems. Rather than viewing ontology development as a collection of isolated Protégé operations, SKDL organizes the entire engineering process into seven progressive stages that gradually transform conceptual knowledge into executable intelligence.

This chapter (18) begins **Stage 1 -- Conceptual Modeling**, the foundation upon which every subsequent stage of the lifecycle depends.
...
## 18.3 Position Within the Semantic Knowledge Development Lifecycle

As introduced in Chapter (17), ontology engineering progresses through seven stages of the **Semantic Knowledge Development Lifecycle (SKDL)**.
...
## 18.4 Exercise 14 -- Creating the First Conceptual Hierarchy
...
### 18.4.1 `Pizza` -- The General Concept
...
### 18.4.2 `NamedPizza` -- Introducing an Intermediate Abstraction
...
### 18.4.3 `MargheritaPizza` -- The First Concrete Domain Concept
...
### 18.4.4 An Engineering Perspective
...
## 18.5 Why Conceptual Modeling Comes Before Semantic Modeling
...
### 18.5.1 Concept Identification Before Semantic Definition
...
### 18.5.2 The Engineering Pattern Across Disciplines
...
### 18.5.3 Why Modeling Semantics Too Early Creates Problems
...
### 18.5.4 Conceptual Modeling as the Foundation of EKA Knowledge
...
### 18.5.5 From Structure to Meaning
...
Chapter (18) focuses on the first step of this journey.
...
## 18.6 Building a Semantic Taxonomy
...
### 18.6.1 Generalization and Specialization
...
### 18.6.2 Designing for Semantic Growth
...
### 18.6.3 More Than Classification
...
### 18.6.4 The Conceptual Backbone of Semantic Knowledge
...
## 18.7 From Taxonomy to Semantic Inheritance
...
### 18.7.1 From Organization to Meaning
...
### 18.7.2 The Meaning of `SubClassOf`
...
### 18.7.3 Semantic Inheritance in Practice
...
### 18.7.4 Semantic Inheritance Is Not Software Inheritance
...
### 18.7.5 Why Semantic Inheritance Matters
...
### 18.7.6 From Conceptual Hierarchies to Logical Reasoning
...
## 18.8 Interesting Reading -- Mathematical Foundations of Semantic Taxonomy
...
### 18.8.2 Why Inheritance Happens Automatically
...
### 18.8.3 A Taxonomy as a *Partially Ordered Set*
...
### 18.8.4 Why Ontology Engineers Should Care
...
## 18.9 Engineering Perspective -- Modeling Before Meaning
...
### 18.9.1 Separating Conceptual Structure from Semantic Meaning
...
### 18.9.2 Exercise 14 as an Engineering Case Study
...
### 18.9.3 Engineering Before Implementation
...
### 18.9.4 The Role of the Semantic Knowledge Development Lifecycle
...
### 18.9.5 Why Incremental Modeling Matters
...
### 18.9.6 Engineering Perspective
...
### 18.9.7 Transition to the Next Perspective
...
## 18.10 Interesting Reading -- Two Great Classification Traditions
...
### 18.10.1 Biological Taxonomy: Nature's Original Ontology
...
#### 18.10.1.1 Linnaean Classification System
...
#### 18.10.1.2 Biological Taxonomy and the `Pizza` Ontology
...
#### 18.10.1.3 From Classification to Ontology Engineering
...
### 18.10.2 Library Classification: Organizing Human Knowledge
...
#### 18.10.2.1 Dewey Decimal Classification
...
#### 18.10.2.2 Library of Congress Classification
...
#### 18.10.2.3 Library Classification and Ontology Engineering
...
### 18.10.3 What Both Traditions Teach Ontology Engineers
...
## 18.11 EKA Perspective -- Conceptual Modeling Establishes the Knowledge Layer ($K$)

The two great classification traditions explored in the previous section teach us an important lesson:
- Biological taxonomy organizes the natural world.
- Library classification organizes human knowledge.

Although they were developed independently and for different purposes, both demonstrate the same fundamental principle:

> **Organizing knowledge into coherent conceptual structures is one of humanity's most enduring and effective strategies for managing complexity.**

Neither system begins with detailed descriptions, logical rules, or sophisticated reasoning.

Instead, both begin by identifying concepts, organizing them into meaningful hierarchies, and establishing relationships that enable knowledge to be understood, navigated, and progressively expanded.

Ontology engineering follows exactly the same philosophy.

The **Executable Knowledge Architecture (EKA)** framework formalizes this long-established strategy for modern semantic knowledge systems, extending conceptual organization into machine-understandable and ultimately machine-executable knowledge.

Throughout this chapter, we have focused exclusively on the first step of that journey.

By identifying concepts such as `Pizza`, `NamedPizza`, and `MargheritaPizza` and organizing them into a semantic taxonomy, we have established the conceptual vocabulary of the domain.

Although the ontology remains relatively simple, it has already completed the first -- and arguably the most fundamental -- stage of the **Executable Knowledge Architecture (EKA)**.

### 18.11.1 Conceptual Modeling and the EKA Tuple

As introduced in Chapter (00), EKA represents executable knowledge through five complementary components:
...
These components are not independent technologies.

Rather, they represent progressively richer layers of semantic capability built upon a common conceptual foundation.

Within this architecture, the work completed in Exercise 14 contributes almost entirely to the $K$ - **Knowledge Graph** layer.

At this stage, the ontology has not yet introduced sophisticated logical restrictions, reasoning rules, event processing, or executable behavior

Instead, it has established something even more fundamental:

> **A shared conceptual model describing what exists within the domain.**

This conceptual model provides the semantic vocabulary upon which every subsequent stage of semantic knowledge development depends.

### 18.11.2 Mapping Chapter 18 to the EKA Framework

The contribution of this chapter to each component of the EKA tuple can be summarized as follows:

| EKA Component | Contribution of Chapter (18) |
| --- | --- |
...
| **$R$ - Reasoning & Rules** | Not yet introduced. The conceptual taxonomy provides the structure upon which logical axioms, restriction, and inference rules will later operate. |
| **$\Theta$ - Trigger** | Not involved at this stage. Semantic events require formal semantics descriptions that will be developed in later chapters. |
| **$\Phi$ - Execution** | No executable behavior has been defined. The ontology currently models knowledge rather than operational processes. |
| **$\Gamma$ - Governance** | Concept naming, abstraction, and hierarchy organization establish the first elements of semantic governance, supporting long-term consistency, maintainability, and evolution. |

This mapping illustrates an important characteristic of EKA:

> **Executable intelligence cannot emerge without a well-structured knowledge foundation.**

The five components are **progressive rather than parallel**.

Each layer depends upon the successful completion of the layers beneath it.

### 18.11.3 Why the Knowledge Layer Comes First

Many newcomers to ontology engineering are naturally attracted to the more advanced capabilities of semantic technologies.

Automated reasoning, intelligent querying, knowledge validation, and AI-driven decision support are all compelling examples of what ontologies can achieve.

However, none of these capabilities can exist without a well-organized conceptual foundation.

- Reasoning engines cannot infer relationships between concepts that have never been identified.
- Validation mechanisms cannot enforce constraints upon concepts that have not yet been modeled.
- Semantic queries cannot retrieve knowledge that lacks a coherent conceptual structure.
- Likewise, intelligent automation cannot operationalize knowledge that has not first been represented semantically.

For this reason, the **$K$ - Knowledge Graph** layer is not simply one component of EKA.

It is the architectural foundation upon which every other component depends.

### 18.11.4 From Conceptual Organization to Executable Knowledge

The significance of Exercise 14 therefore extends far beyond creating two additional class in Protégé.

By introducing `NamedPizza` and `MargheritaPizza`, the ontology has established a reusable conceptual taxonomy capable of supporting further semantic enrichment.

Over the remaining stages of **Semantic Knowledge Development Lifecycel (SKDL)**, this taxonomy will progressively acquire:
...
In other words, the ontology evolves from:

```mermaid
flowchart LR
A[Concept]-->B[Semantic Meaning]
-->C[Logical Knowledge]-->D[Reasoning]-->E[Executable Intelligence]
```

Every subsequent capability introduced throughout this book ultimately depends upon the conceptual foundation established in this chapter.

### 18.11.5 An Architectural Perspective

Biological taxonomy provides the conceptual structure for understanding the natural world.

Library classification provides the conceptual structure for organizing human knowledge.

In exactly the same way, **Conceptual Modeling** provides the conceptual structure for semantic knowledge systems.

The comparison is more than an analogy.

All three systems begin with the same architectural principle:

> **Structure precedes meaning, and meaning precedes intelligence.**

Within the EKA framework, this principle explains why **$K$ - Knowledge Graph** occupies the first position in the EKA tuple.

- Without concepts, there can be no semantics.
- Without semantics, there can be no reasoning.
- Without reasoning, there can be no executable knowledge.

### 18.11.6 Engineering Takeaway

Stage 1 -- **Conceptual Modeling** should therefore never be viewed as merely creating classes within Protégé.

Instead, it establishes the semantic vocabulary that defines the scope of the ontology, organizes knowledge into reusable conceptual structures, and provides the architectural foundation for every subsequent stage of semantic knowledge development.

Just as biological taxonomy and library classification have enabled generations of scientists and scholars to manage increasingly complex ***bodies of knowledge***, Conceptual Modeling enables ontology engineers to construct semantic knowledge systems that are scalable, maintainable, governable, and ultimately executable.

For this reason, Stage 1 is not simply the beginning of the **Semantic Knowledge Development Lifecycle**.

It is the indispensable foundation upon with the entire **Executable Knowledge Architecture (EKA)** is progressively constructed.

## 18.12 Engineering Guidelines for Conceptual Modeling

Conceptual Modeling is far more than simply creating classes within Protégé.

Although the mechanics of defining subclasses are straightforward, designing a semantic taxonomy that remains **understandable**, **reusable**, and **maintainable** over time requires careful engineering judgment.

Experienced ontology engineers recognize that conceptual modeling establishes the foundation upon which every subsequent stage of ontology development depends. Decisions made during this stage influence semantic descriptions, logical reasoning, governance policies, validation strategies, and future extensibility.

The following engineering guidelines summarize widely accepted practices for building robust conceptual hierarchies.

### 18.12.1 Think Semantically Rather Than Visually

One of the most common beginner mistakes is designing an ontology based primarily on how the class hierarchy appears in Protégé.

Although Protégé displays concepts as a tree, the objective is not to produce an attractive diagram. Every node represents a formal semantic concept, and every edge represents a logical **IS-A** relationship.

Each node represents a formal semantic concept (with IRI), not merely a visual element.

This distinction need to be carefully understood, especially when transitioning from visual diagraming tools (such as Microsoft Visio or draw.io) to Protégé.

When deciding where a class belongs, always ask:

> **Is every instance of this class also an instance of its parent?**

- If the answer is yes, the subclass relationship is probably appropriate.
- If not, the hierarchy should be reconsidered.
...
For example, the following hierarchy is semantically correct:
...
A common mistake is organizing classes according to convenience rather than meaning.

For example, placing `PizzaBase` or `PizzaTopping` beneath `Pizza` simply because they are "related" to pizzas would incorrectly imply that every pizza base ***is a*** pizza.
...
> **Semantic correctness is always more important than visual appearance.**

### 18.12.2 Model Concepts Before Properties

Another frequent mistake is attempting to define object properties, restrictions, and logical axioms before the conceptual hierarchy has stabilized.

Professional ontology development follows a deliberate progression.

1. First identify the concepts.
2. Then organize them into a coherent taxonomy.
3. Only after the conceptual structure has become sufficiently stable should semantic relationships and logical constraints be introduced.

This staged approach reduces unnecessary redesign as the ontology evolves.

Exercise 14 deliberately follows this philosophy.

At this point in the tutorial, `MargheritaPizza` has been introduced as a concept, but it still contains no semantic definition regarding its toppings, ingredients, or distinguishing characteristics.

Those semantic descriptions belong to the next stage of the Semantic Knowledge Development Lifecycle:

> **Identify concepts first. Describe their meaning later.**

Separating conceptual organization from semantic specification produces ontologies that are easier to **understand**, **extend**, and **maintain**.

### 18.12.3 Prefer Generalization Before Duplication

Whenever several concepts share common characteristics, introduce an appropriate higher-level abstraction instead of repeatedly modeling similar structures.

The introduction of `NamedPizza` provides an excellent example.

Instead of placing every pizza variety directly beneath `Pizza`, the ontology introduces an intermediate abstraction that represents commercially recognized pizzas.

As additional pizzas are introduced in later chapters, they naturally become subclasses of `NamedPizza`, avoiding unnecessary duplication while keeping the hierarchy organized.

Without this abstraction, the taxonomy would gradually become increasingly crowded as new pizza varieties were added.

Generalization therefore improves:
- semantic reuse;
- maintainability;
- consistency; and
- future extensibility.

This principle closely parallels inheritance in software engineering and normalization in database design:

> **Model common knowledge once, then allow specialized concepts to inherit it.**

### 18.12.4 Design for Future Growth

An ontology should never be designed solely to satisfy current requirements.

Instead, it should provide a conceptual framework capable of accommodating future expansion without major structural redesign.

Exercise 14 illustrates this principle perfectly.

Although only one concrete pizza (`MargheritaPizza`) currently exists beneath `NamedPizza`, the abstraction anticipates many future subclasses.

Later chapters will introduce additional pizzas such as `AmericanaPizza`, `CapricciosaPizza`, `FourSeasonsPizza`, and others.

Because the conceptual hierarchy has already been established, these additions require no architectural changes.

A scalable taxonomy should allow new concepts to fit naturally within the existing structure.

Professional ontology engineers therefore design today's hierarchy with tomorrow's ontology in mind.

### 18.12.5 Maintain Consistent Levels of Abstraction

Sibling classes should represent concepts at the same level of ***generality***.
...
For example, the following hierarchy maintains a consistent level of abstraction:
...
Each child represents a major conceptual category within the ontology. (Top level concepts are subClassOf `owl:Thing`)

By contrast, the following organization mixes different abstraction levels:
...
Here, `NamedPizza` represents a broad abstraction, `MargheritaPizza` represents a concrete pizza type, and `MozzarellaTopping` belongs to an entirely different conceptual branch.

Although Protégé allows such structures, they reduce readability and often indicate weaknesses in conceptual design

Maintaining consistent abstraction levels improves both human understanding and automated reasoning.

### 18.12.6 Distinguish Classes from Individuals

Another common source of confusion is failing to distinguish between **types** and **instances**.
...
Individuals represent concrete objects belonging to those categories

For example:

  - `MargheritaPizza` is a class
  - "The pizza served on Table 5" is an individual
  - `NamedPizza` describes a category.
  - `Pizza #1045" represents a particular instance.

This distinction mirrors the relationship between a blueprint and the building constructed from it.

- The blueprint defines a type.
- The completed building is an instance of that type.

Maintaining a clear distinction between classes and individual **prevent conceptual confusion** and ensures that ontologies accurately represent domain knowledge rather than operational data.

### 18.12.7 Building Stable Taxonomies Before Introducing Semantics

Perhaps the most important lesson of this chapter is that conceptual organization should stabilize before detailed modeling begins.

Many beginners are eager to define restrictions such as:

`hasTopping some MozzarellaTopping`

or

`hasBase some ThinAndCrispyBase`

before establishing whether the conceptual hierarchy itself is appropriate.

Professional ontology engineers work in the opposite order.

They first determine whether concepts such as `NamedPizza`, `VegetarianPizza`, or `SpicyPizza` represent meaningful abstractions.

Only after the conceptual model has matured do they begin enriching it with semantic descriptions.

This incremental approach greatly reduces restructuring later in the development process and produces ontologies that remain coherent as they grow.

It also reflects the philosophy of the **Semantic Knowledge Development Lifecycle (SKDL)**.

- Stage 1 establishes the conceptual foundation.
- Stage 2 enriches that foundation with semantic meaning.

Subsequent stages progressively introduce reuse, governance, validation, reasoning, and executable knowledge.

> **A stable conceptual taxonomy is the prerequisite for every subsequent stage of ontology engineering.**

### 18.12.8 Engineering Takeaway

Although creating subclasses in Protégé requires only a few mouse clicks, constructing an effective conceptual model requires considerably more thought.

A well-designed taxonomy should accurately represent the conceptual structure of the domain, support semantic inheritance, encourage reuse, accommodate future growth, and provide a stable foundation for semantic enrichment.

The engineering guidelines presented in this section are not specific to the `Pizza` ontology. They reflect general principles that apply equally to enterprise ontologies, biomedical knowledge graphs, digital libraries, manufacturing systems, and large-scale semantic knowledge bases.

By following these principles, ontology engineers create conceptual models that remain understandable, maintainable, and extensible long after the initial ontology has been completed.

## 18.13 Key Concepts

Throughout this chapter, we explored Conceptual Modeling from practical, mathematical, engineering, historical and architectural perspectives. The following concepts summarize the essential terminology introduced during **Stage 1 -- Conceptual Modeling** of the Semantic Knowledge Development Lifecycle.

| Concept | Description |
| --- | --- |
| **Conceptual Modeling** | The process of identifying, abstracting, and organizing domain concepts into a coherent semantic structure before introducing formal semantic definitions or logical axioms. |
| **Conceptual Vocabulary** | The complete collection of concepts that define the scope of an ontology and provide the shared language of a knowledge domain. |
| **Taxonomy** | A structured classification system that organizes concepts according to **`IS-A`** relationships, enabling semantic organization and reuse. |
| **Semantic Taxonomy** | A hierarchical organization of concepts based on generalization and specialization, forming the conceptual backbone of an ontology. |
| **Generalization** | The process of identifying common characteristics shared by multiple concepts and representing them through a higher-level abstraction. |
| **Specialization** | The process of refining a general concept into more specific semantic categories while preserving inherited semantic meaning. |
| **Abstraction** | The engineering practice of modeling common knowledge at an appropriate conceptual level to improve reuse, maintainability, and scalability within the ontology. |
| **Subclass (`SubClassOf`)** | An OWL construct expressing that every instance of one class is also an instance of another class, representing an **`IS-A`** relationship. |
| **Semantic Inheritance** | The automatic logical inheritance of semantic meaning from parent classes to their subclasses through the ontology hierarchy. |
| **Conceptual Hierarchy** | A semantic structure that organizes concepts into multiple levels of abstraction, supporting reuse, extensibility, and automated reasoning. |
| **$K$ - Knowledge Graph Layer** | The first component of the Executable Knowledge Architecture (EKA), establishing the conceptual vocabulary and semantic structure upon which reasoning, governance, and execution are progressively built. |
| **Stage 1 - Conceptual Modeling** | The first stage of the Semantic Knowledge Development Lifecycle (SKDL), responsible for establishing the conceptual foundation of an ontology before semantic enrichment begins. |

## 18.14 Chapter Summary

This chapter introduced **Stage 1 -- Conceptual Modeling**, the first stage of the **Semantic Knowledge Development Lifecycle (SKDL)** and the essential standing point of professional ontology engineering.

Using **Exercise 14** from Michael DeBellis' *Protégé 5 New OWL `Pizza` Tutorial* as a practical case study, we explored how ontology engineers begin by identifying and organizing concepts before introducing formal semantics. Although the modeling exercise only the creation of two new classes -- `NamedPizza` and `MargheritaPizza` -- its engineering significance extends far beyond adding nodes to a class hierarchy.

Throughout the chapter, we demonstrated that a subclass hierarchy is not simply a visual tree displayed within Protégé. Instead, it represents a **semantic taxonomy** in which every subclass expresses as `IS-A` relationships with its parent and inherits its conceptual meaning. This semantic organization provides the stable foundation upon which later stages of ontology development progressively introduce richer semantic descriptions, reusable modeling patterns, governance policies, validation mechanisms, automated reasoning, and ultimately executable knowledge.

To place Conceptual Modeling in a broader context, we examined the discipline from several complementary perspectives.

From an **engineering perspective**, we emphasized that every mature engineering discipline begins by identifying the concepts that define its problem domain before describing their behavior or implementation.

From a **mathematical perspective**, we interpreted subclass hierarchies as subset relationships within set theory and showed how semantic inheritance naturally follows from the transitivity of subset inclusion.

From a **historical perspective**, we explored two of humanity's most influential classification traditions. Biological taxonomy demonstrated how the natural world can be organized through hierarchical specialization, while library classification illustrated how human knowledge can be systematically structured into navigable conceptual hierarchies. Although developed for different purposes, both traditions reinforce the same fundamental principle:

> **Complex knowledge becomes understandable only after it has been organized conceptually.**

Finally, we related Conceptual Modeling to the **Executable Knowledge Architecture (EKA)** framework. Within EKA, the work completed in this chapter establishes the **$K$ -- Knowledge Graph** layer by defining the conceptual vocabulary and semantic taxonomy that support every subsequent architectural capability.

Without this foundation:
- reasoning has no concepts to infer over,
- governance has no structure to manage,
- validation has no model to verify, and
- execution has no knowledge to operationalize.

By the end of this chapter, the `Pizza` ontology has progressed from a collection of isolated OWL constructs to a coherent conceptual model.

Although the ontology still contains relatively little semantic detail, it now possesses the stable conceptual foundation required for the next stage of semantic development.

## 18.15 Looking Ahead -- From Concepts to Meaning

At the conclusion of this chapter, the `Pizza` ontology contains a coherent conceptual taxonomy.

Concepts such as `Pizza`, `NamedPizza`, and `MargheritaPizza` have been identified, organized into a meaningful hierarchy, and connected through formal `SubClassOf` relationships.

The ontology therefore knows **what concepts exist** and **how they are conceptually related**.

However, an important question remains unanswered:

> **What actually distinguishes one concept from another?**

At present, the ontology understands that a `MargheritaPizza` is a specialized type of `NamedPizza`, but it does not yet understand ***why*** it is a Margherita pizza. The hierarchy identifies the concept, but it does not yet describe its semantic meaning.

For example, the ontology cannot yet answer questions such as:

- Which toppings defines a `MargheritaPizza`?
- Which ingredients distinguish it from other named pizzas?
- Which logical restrictions characterize this class?
- how can an OWL reasoner automatically recognize a pizza as a `MargheritaPizza`?

Answering these questions requires more than conceptual organization. It requires **formal semantic descriptions** expressed through OWL axioms, property restrictions, and logical class definitions.

This transition marks the beginning of **stage 2 -- Semantic Description** within the Semantic Knowledge Development Lifecycle.

Whereas **Stage 1** established the conceptual vocabulary of the domain, **Stage 2** progressively enriches those concepts with machine-interpretable meaning. Rather than merely stating that concepts exist, ontology engineers begin specifying the semantic characteristics that distinguish one concept from another and enable automated reasoning.

The journey therefore continues from answering:

> **What concepts exist within the domain?**

to answer the equally important question:

> **What do those concepts actually mean?**
> 
---

Last updated at: 2026-08-08, renamed from original Chapter 16