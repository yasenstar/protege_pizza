...
This chapter re-examines **Exercise 17** and **Exercise 18** from Michael DeBellis' *Protégé 5 New OWL Pizza Tutorial* through the lens of semantic governance.

In the tutorial, Exercise 17 continues the incremental construction of `pizza` varieties -- creating `AmericanaHotPizza` and `SohoPizza` thorugh cloning  demonstrating how modular organization and explicit constraints transform an ontology from a collection of reusable assets into a governed, trustworthy knowledge infrastructure.
...
- [21.4 Exercise 17 -- Organizing the `Pizza` Ontology into Modules](#214-exercise-17----organizing-the-pizza-ontology-into-modules)
...
- Describe the purpose of modular ontologies in maintaining semantic integrity
- Understanding the relationship between governance, reuse, and trust in knowledge systems
...
**Practical Skills**:
- Organize an ontology into coherent modules using Protégé
...
- Prepare an ontology for governance using **Exercise 17** and **Exercise 18** from the `Pizza` tutorial
...
- **Modular Organization** -- breaking large ontologies into cohesive, independently maintainable units
...
Within the EKA framework, **Stage 4** establishes the **$\Gamma$ -- Governance layer** by providing the policies, standards, and processes that ensures semantic knowledge remains reliable when it moves from an ontology model into
- production systems,
- enterprise decisions, and
- AI-driven automation.

## 21.4 Exercise 17 -- Organizing the `Pizza` Ontology into Modules

Having established the engineering motivation for **Semantic Governance**, we now turn to its practical implementation through **Exercise 17** in Michael DeBellis' *Protégé 5 New OWL Pizza Tutorial*.
...
Unlike the previous exercises, which introduced individual OWL constructors or semantic modeling patterns, Exercise 17 focuses on **organizing the ontology** --

> restructuring its components into coherent, maintainable modules that can be **governed** effectively.



---

Last updated at 2026-08-27