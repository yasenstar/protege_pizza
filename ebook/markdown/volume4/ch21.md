...
| --- | --- |
| $K$ -- Knowledge Graph | Modular organization establishes a governance structure. Naming conventions ensure consistent identification. Documentation captures design rationale. |
| $R$ -- Reasoning & Rules | Disjointness axioms provide additional constraints that improve reason
