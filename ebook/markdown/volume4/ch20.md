...
- [20.4 Exercise 17 -- Practicing Reuse Through Specialization](#204-exercise-17----practicing-reuse-through-specialization)
  - [20.4.1 Creating `AmericanaHotPizza`](#2041-creating-americanahotpizza)
  - [20.4.2 Creating `SohoPizza`](#2042-creating-sohopizza)
  - [20.4.3 The Governance Implication of Cloning](#2043-the-governance-implication-of-cloning)
  - [20.4.4 From Ad Hoc Reuse to Governed Reuse](#2044-from-ad-hoc-reuse-to-governed-reuse)
  - [20.4.5 The Resulting Hierarchy](#2045-the-resulting-hierarchy)
  - [20.4.6 Engineering Perspective](#2046-engineering-perspective)
- [20.5 Reuse Before Rebuild -- An Engineering Pattern](#205-reuse-before-rebuild----an-engineering-pattern)
  - [20.5.1 The Pattern in Software Engineering](#2051-the-pattern-in-software-engineering)
  - [20.5.2 The Pattern in Enterprise Architecture](#2052-the-pattern-in-enterprise-architecture)
  - [20.5.3 The Pattern in Design and Manufacturing](#2053-the-pattern-in-design-and-manufacturing)
  - [20.5.4 From Copying to Knowledge Reuse](#2054-from-copying-to-knowledge-reuse)
  - [20.5.5 The Role of Variation in Knowledge Reuse](#2055-the-role-of-variation-in-knowledge-reuse)
  - [20.5.6 The Limits of Cloning](#2056-the-limits-of-cloning)
  - [20.5.7 The Engineering Attitude](#2057-the-engineering-attitude)
- [20.6 Reusable Semantic Patterns in OWL](#206-reusable-semantic-patterns-in-owl)
  - [20.6.1 Inheritance (`SubClassOf`)](#2061-inheritance-subclassof)
  - [20.6.2 Equivalent Class Definitions (`EquivalentTo`)](#2062-equivalent-class-definitions-equivalentto)
  - [20.6.3 Reusable Restriction Patterns](#2063-reusable-restriction-patterns)
  - [20.6.4 Ontology Imports (`owl:imports`)](#2064-ontology-imports-owlimports)
  - [20.6.5 Design Patterns](#2065-design-patterns)
  - [20.6.6 Semantic Alignment](#2066-semantic-alignment)
- [20.7 Reuse Across Disciplines - Mechanisms](#207-reuse-across-disciplines---mechanisms)
  - [20.7.1 Software Engineering -- Inheritance and Composition](#2071-software-engineering----inheritance-and-composition)
  - [20.7.2 Enterprise Architecture -- Capability Reuse and Reference Architecture](#2072-enterprise-architecture----capability-reuse-and-reference-architecture)
  - [20.7.3 Scientific Research -- Citation and Systematic Review](#2073-scientific-research----citation-and-systematic-review)
  - [20.7.4 Biology -- Gene Duplication and Regulatory Review](#2074-biology----gene-duplication-and-regulatory-review)
  - [20.7.5 Artificial Intelligence -- Transfer Learning and Model Adaptation](#2075-artificial-intelligence----transfer-learning-and-model-adaptation)
- [20.8 Mathematical Perspective -- Abstraction, Generalization and Reuse](#208-mathematical-perspective----abstraction-generalization-and-reuse)
  - [20.8.1 Generalization as Subset Inclusion](#2081-generalization-as-subset-inclusion)
  - [20.8.2 Abstraction and Dimension Reduction](#2082-abstraction-and-dimension-reduction)
  - [20.8.3 Posets and Lattices](#2083-posets-and-lattices)
  - [20.8.4 Reuse and Logical Consistency](#2084-reuse-and-logical-consistency)
- [20.9 Interesting Reading -- From Plato to Design Patterns](#209-interesting-reading----from-plato-to-design-patterns)
  - [20.9.1 Plato's Forms: The First Reusable Knowledge Assets](#2091-platos-forms-the-first-reusable-knowledge-assets)
  - [20.9.2 Aristotle's Genus and Differentia: The First Reuse Pattern](#2092-aristotles-genus-and-differentia-the-first-reuse-pattern)
  - [20.9.3 Porphyry's Tree: The First Reusable Taxonomy](#2093-porphyrys-tree-the-first-reusable-taxonomy)
  - [20.9.4 Kant and the Conceptual Schema: Reusable Categories as Preconditions of Knowledge](#2094-kant-and-the-conceptual-schema-reusable-categories-as-preconditions-of-knowledge)
  - [20.9.5 Christopher Alexander and the Language of Patterns](#2095-christopher-alexander-and-the-language-of-patterns)
  - [20.9.6 From Software Patterns to Ontology Design Patterns](#2096-from-software-patterns-to-ontology-design-patterns)
- [20.10 EKA Perspective -- Stage 3 Strengthens $K$ and Prepares $\\Gamma$](#2010-eka-perspective----stage-3-strengthens-k-and-prepares-gamma)
  - [20.10.1 Reuse and the EKA Tuple](#20101-reuse-and-the-eka-tuple)
  - [20.10.2 Strengthening $K$ -- The Knowledge Graph Layer](#20102-strengthening-k----the-knowledge-graph-layer)
  - [20.10.3 Preparing $\\Gamma$ -- The Governance Layer](#20103-preparing-gamma----the-governance-layer)
    - [20.10.3.1 **The SDC Model: Governance as Data Physics \[^2\]**](#201031-the-sdc-model-governance-as-data-physics-2)
  - [20.10.4 From Kant to EKA: The Architectural Meaning of Reusable Categories](#20104-from-kant-to-eka-the-architectural-meaning-of-reusable-categories)
  - [20.10.5 The Maturity Arc: From $K$ to $\\Gamma$](#20105-the-maturity-arc-from-k-to-gamma)
  - [20.10.6 Engineering Takeaway](#20106-engineering-takeaway)
- [20.11 Engineering Guidelines for Knowledge Reuse](#2011-engineering-guidelines-for-knowledge-reuse)
  - [20.11.1 Design for Reuse from the Start](#20111-design-for-reuse-from-the-start)
  - [20.11.2 Reuse Before Create](#20112-reuse-before-create)
  - [20.11.3 Clone Deliberately, Then Specialize](#20113-clone-deliberately-then-specialize)
  - [20.11.4 Abstract Common Patterns](#20114-abstract-common-patterns)
  - [20.11.5 Govern What You Reuse](#20115-govern-what-you-reuse)
  - [20.11.6 Validate After Every Reuse](#20116-validate-after-every-reuse)
  - [20.11.7 Think in Patterns, Note Instances](#20117-think-in-patterns-note-instances)
  - [20.11.8 Document the Semantic Lineage](#20118-document-the-semantic-lineage)
  - [20.11.9 Engineering Takeaway](#20119-engineering-takeaway)
...
- [20.14 Looking Ahead -- Knowledge Governance](#2014-looking-ahead----knowledge-governance)
  - [20.14.1 From Reuse to Governance](#20141-from-reuse-to-governance)
  - [20.14.2 What Semantic Governance Entails](#20142-what-semantic-governance-entails)
  - [20.14.3 The SDC Model as Governance Infrastructure](#20143-the-sdc-model-as-governance-infrastructure)
  - [20.14.4 The Path Forward](#20144-the-path-forward)
  - [20.14.5 The Arc of the Lifecycle](#20145-the-arc-of-the-lifecycle)
- [Reference](#reference)
...
## 20.4 Exercise 17 -- Practicing Reuse Through Specialization

In the previous section, **Exercise 16** demonstrated the fundamental principle of knowledge reuse through cloning:

1. duplicating an existing class,
2. preserving its validated semantics, and
3. introducing only the necessary variation.

**Exercise 17** now asks us to apply this same pattern to create two additional pizza varieties:
...
At first glance, this exercise appears to be a simple repetition of the cloning technique from **Exercise 16**. However, its engineering significance extends beyond mere repetition.

**Exercise 17** demonstrates that

> **reuse is not a one-time activity -- it is a recurring engineering practice**.

Each cloning operation reinforce the principle of "reuse before redesign" while introducing new variations that expand the ontology's coverage of the domain.

### 20.4.1 Creating `AmericanaHotPizza`

The first part of **Exercise 17** asks us to create `AmericanaHotPizza` by cloning `AmericanaPizza` and adding an existential restriction for `JalapenoPepperTopping`.

**Step 1: Clone `AmericanaPizza**

1. Navigate to the `Classes` tab in Protégé.
2. Select `AmericanaPizza` from the class hierarchy.
3. Select menu Edit > Duplicate, or right click select Duplicate selected class.
4. In the dialog that appears, change the name from `AmericanaPizza` to `AmericanaHotPizza`.
5. Leave all other options as they are and select `OK`.

![ch20_11_ex17-01](img/ch20_11_ex17-01.png)

**Step 2: Add the distinguishing restriction**

1. Make sure `AmericanaHotPizza` is still selected in the Classes hierarchy.
2. Click on the Add icon (+) next to the `SubClass Of` field in the Description view.
3. Select the `Class expression editor` tab.
4. Enter: `hasTopping some JalapenoPepperTopping`.
5. Click `OK`.

![ch20_12_ex17-02](img/ch20_12_ex17-02.png)

**Step 3: Update documentation (Governance Practice)**

1. In the `Annotations view, edit the `rdfs:comment` for `AmericanaHotPizza`.
2. Update it to reflect the new definition: "A pizza that has Mozzarella, Tomato, Pepperoni, and Jalapeno Pepper toppings."
  ![ch20_13_ex17-03](img/ch20_13_ex17-03.png)
3. Add governance documentation: "Created by cloning from AmericanaPizza. Additional restriction: hasTopping some JalapenoPepperTopping. Source: AmericanaPizza. Date: [YYYY-MM-DD]"
   ![ch20_14_ex17-04](img/ch20_14_ex17-04.png)
   *The updated `rdfs:comment` for `AmericanaHotPizza`, documenting its semantic lineage.*

**Step 4: Synchronize the reasoner**

1. Select menu Reasoner > Synchronize reasoner, or shortcut `Ctrl` + `R`.
2. Verify that no inconsistencies have been introduced.
3. Check that the reasoner has correctly classified `AmericanaHotPizza`.

![ch20_15_ex17-05](img/ch20_15_ex17-05.png)

### 20.4.2 Creating `SohoPizza`

The second part of **Exercise 17** asks us to create `SohoPizza` by cloning `MargheritaPizza` and adding two existential restrictions.

**Step 1: Clone `MargheritaPizza**

1. Navigate to the `Classes` tab in Protégé.
2. Select `MargheritaPizza` from the class hierarchy.
3. Select Edit > Duplicate selected class.
4. In the dialog that appears, change the name from `MargheritaPizza` to "SohoPizza`.
5. Leave all other options as they are and select `OK`.

![ch20_16_ex17-06](img/ch20_16_ex17-06.png)

**Step 2: Add the distinguishing restrictions**

1. Make sure `SohoPizza` is still selected.
2. Click on the Add icon (+) next to the `SubClass Of` field in the Description view.
3. Select the `Class expression editor` tab.
4. Enter: `hasTopping some OliveTopping`.
5. Click OK.
6. Repeat above 2-5 to add: `hasTopping some ParmesanTopping`.

![ch20_17_ex17-07](img/ch20_17_ex17-07.png)

**Step 3: Update documentation (Governance Practice)**

1. In the Annotations view, edit the `rdfs:comment` for `SohoPizza`.
2. Update it to reflect the new definition: "A pizza that has Mozzarella, Tomato, Olive, and Parmesan toppings."
3. Add governance documentation: "Created by cloning from MargheritaPizza. Additional restrictions: hasTopping some OliveTopping, hasTopping some ParmesanTopping. Source: MargheritaPizza. Date:[YYYY-MM-DD]."

![ch20_18_ex17-08](img/ch20_18_ex17-08.png)

**Step 4: Synchronize the reasoner (Validation Discipline)**

1. Select Reasoner > Synchronize reasoner.
2. Verify that no inconsistencies have been introduced.
3. Check that the reasoner has correctly classified `SohoPizza`.

![ch20_19_ex17-09](img/ch20_19_ex17-09.png)

### 20.4.3 The Governance Implication of Cloning

From the perspective of Protégé, **Exercise 17** involves cloning two classes and adding restrictions.

From the perspective of ontology engineering, however, something more significant has occurred -- and something more concerning:

> **The Governance Problem**

When we clone `MargheritaPizza` to create `SohoPizza`, we create two classes that share a semantic lineage.

- Both classes inherit from `NamedPizza`. (The duplicated class is added under same parent class as original class.)
- Both classes share the the same base restriction: `hasTopping some MozzarellaTopping` and `hasTopping some TomatoTopping`.
- Both classes are conceptually related.

However, the ontology does not capture this relationship. The reasoner treats `MargheritaPizza` and `SohoPizza` as unrelated concepts, or say just two different named pizzas. The semantic lineage exists only in the engineer's (human) mind -- and possibly in the documentation, if the engineer remembered to update it.

This is the governance challenge introduced by reuse:

> **Reuse creates semantic lineage. Semantic lineage requires governance.**

Without governance, cloned classes tend to diverge over time. One class may be updated with the new restrictions. Another may be deprecated. A third may be extended in ways that are inconsistent with the original intent. The semantic lineage is lost, and the ontology becomes increasingly difficult to maintain.

### 20.4.4 From Ad Hoc Reuse to Governed Reuse

**Exercise 17** demonstrates the **limit of ad hoc reuse**.

Cloning is effective for small-scale reuse, but it does not provide the governance infrastructure required for long-term maintainability.

To move from ad hoc reuse to governed reuse, ontology engineers must adopt some additional practices:

**1. Document Semantic Lineage**

Every cloned class should document its source, the rationale for cloning, and the variations introduced. Data stamping is also important.

If the ontology is used within a team with collaboration mode, document the owner (who does the cloning) is recommended.

This documentation should be captured in `rdfs:comment` annotations.

For example, `SohoPizza` might include:

```text
rdfs:comment "A pizza that has Mozzarella, Tomato, Olive, and Parmesan toppings.
Created by cloning MargheritaPizza. Additional restrictions: hasTopping some OliveTopping,
hasTopping some ParmesanTopping. Source: MargheritaPizza. Date: 2026-08-28."
```

> [!Note]
> You can put class description and documentation in one single `rdfs:comment`, or document them in two separate `rdfs:comment`.

**2. Consider Abstraction**

If multiple classes share a common pattern, consider introducing an abstraction that captures the shared knowledge.

For example, if many pizzas share the base restrictions, consider introducing a `TomatoAndMozzarellaPizza` abstraction.

**3. Use Shared SuperClasses**

Rather than cloning, consider whether the new class should be a subclass of an existing abstraction.

For example, if `SohoPizza` is a type of `MargheritaPizza` with additional toppings, perhaps it should be a subclass of `MargheritaPizza` rather than a cloned sibling.

**4. Validate after Every Reuse**

After every reuse operations, run the reasoner to verify that no inconsistencies have been introduced. This is especially important then cloning, as cloned classes may inherit restrictions that are incompatible with new restrictions.

**5. Govern what You Reuse**

Assign ownership to reusable patterns. Establish versioning policies. Define quality standards. Ensure that reuse is not anarchy.

> [!Note]
> Never underestimate the importance of these governance disciplines. Without clear ownership, versioning, and quality standards, even the best-designed ontology will gradually become unmaintainable. Governance is not optional -- it is essential.

### 20.4.5 The Resulting Hierarchy

Following the **Use Shared SuperClasses** practice discussed earlier, let's define these cloned classes as subclasses of their original classes. This approach better captures the semantic relationship between the classes -- rather than treating them as unrelated siblings under `NamedPizza`, it explicitly expresses that `SohoPizza` is a specialized type of `MargheritaPizza` and `AmericanaHotPizza` is a specialized type of `AmericanaPizza`. The reasoner can then leverage these relationships for more precise inference and classification.

After completing **Exercise 17**, the class hierarchy under `NamedPizza` should look like this:

![ch20_20_ex17-10](img/ch20_20_ex17-10.png)

> *Source: The reference RDF file is "pizza-ebook_ex17.rdf", check from project GitHub repository.*

### 20.4.6 Engineering Perspective

**Exercise 17** reinforces the core principle of **Stage 3 -- Knowledge Reuse**:

> **Well-defined knowledge should be created once, reused many times, and redefined when necessary.**

However, it also reveals that **reuse is not free**.

- Every reuse operation carries governance implications that must be managed.
- The semantic lineage between classes must be documented.
- The relationship between related classes must be made explicit.
- The potential for divergence must be anticipated and mitigated.

These governance concerns are the focus of **Stage 4 -- Semantic Governance**, which will be explored in the next chapter.

For now, **Exercise 17** provides an opportunity to practice the reuse pattern while developing awareness of its governance implications. The discipline of documenting semantic lineage, validating after every reuse, and designing for future governance will serve you well as your ontologies grow in size and complexity.

## 20.5 Reuse Before Rebuild -- An Engineering Pattern
...
### 20.5.1 The Pattern in Software Engineering
...
### 20.5.2 The Pattern in Enterprise Architecture
...
### 20.5.3 The Pattern in Design and Manufacturing
...
### 20.5.4 From Copying to Knowledge Reuse
...
### 20.5.5 The Role of Variation in Knowledge Reuse
...
### 20.5.7 The Engineering Attitude
...
## 20.6 Reusable Semantic Patterns in OWL
...
### 20.6.2 Equivalent Class Definitions (`EquivalentTo`)
...
### 20.6.3 Reusable Restriction Patterns
...
### 20.6.4 Ontology Imports (`owl:imports`)
...
### 20.7.1 Software Engineering -- Inheritance and Composition
...
### 20.7.2 Enterprise Architecture -- Capability Reuse and Reference Architecture
...
### 20.7.3 Scientific Research -- Citation and Systematic Review
...
### 20.7.4 Biology -- Gene Duplication and Regulatory Review
...
### 20.7.5 Artificial Intelligence -- Transfer Learning and Model Adaptation
...
## 20.8 Mathematical Perspective -- Abstraction, Generalization and Reuse
...
### 20.8.1 Generalization as Subset Inclusion
...
### 20.8.2 Abstraction and Dimension Reduction
...
### 20.8.4 Reuse and Logical Consistency
...
### 20.9.1 Plato's Forms: The First Reusable Knowledge Assets
...
### 20.9.2 Aristotle's Genus and Differentia: The First Reuse Pattern
...
### 20.9.3 Porphyry's Tree: The First Reusable Taxonomy
...
### 20.9.4 Kant and the Conceptual Schema: Reusable Categories as Preconditions of Knowledge
...
### 20.9.5 Christopher Alexander and the Language of Patterns
...
### 20.9.6 From Software Patterns to Ontology Design Patterns
...
### 20.10.1 Reuse and the EKA Tuple
...
### 20.10.2 Strengthening $K$ -- The Knowledge Graph Layer
...
### 20.10.3 Preparing $\Gamma$ -- The Governance Layer
...
#### 20.10.3.1 **The SDC Model: Governance as Data Physics [^2]**
...
### 20.10.4 From Kant to EKA: The Architectural Meaning of Reusable Categories
...
### 20.10.5 The Maturity Arc: From $K$ to $\Gamma$
...
### 20.11.1 Design for Reuse from the Start
...
### 20.11.3 Clone Deliberately, Then Specialize
...
### 20.11.4 Abstract Common Patterns
...
### 20.11.6 Validate After Every Reuse
...
### 20.11.7 Think in Patterns, Note Instances
...
### 20.11.8 Document the Semantic Lineage
...
[**Exercise 17**](#204-exercise-17----practicing-reuse-through-specialization) then practices this pattern through the creation of `AmericanaHotPizza` and `SohoPizza`. While these operations appear to be simple repetitions of the cloning technique, they demonstrate that reuse is a recurring engineering practice -- and they reveal the governance implications of cloning. Each cloned class creates a semantic lineage that must be documented and managed. Without governance, cloned classes diverge and the ontology becomes difficult to maintain. These governance concerns prepare the ground for **Stage 4 -- Semantic Governance**.

From these two simple cloning operations the discussion expanded outward. [Section 20.5](#205-reuse-before-rebuild----an-engineering-pattern) framed "clone before create" (or "reuse before build") as a universal engineering pattern visible in class inheritance, package ecosystems, reference architectures, product platforms, and semiconductor IP blocks. It also identified the limits of pure cloning -- maintenance burden, lost lineage, weak reasoning support, and governance challenges -- and pointed toward more mature mechanisms.

[Section 20.6](#206-reusable-semantic-patterns-in-owl) catalogued mechanisms inside OWL itself:
...
Cross-disciplinary analogs ([Section 20.7](#207-reuse-across-disciplines---mechanisms)) and the mathematical treatment ([Section 20.8](#208-mathematical-perspective----abstraction-generalization-and-reuse)) supplied formal grounding.
...
The philosophical lineage ([Section 20.9](#209-interesting-reading----from-plato-to-design-patterns)) showed that the same impulse -- to capture what is general, proven, and reusable, then specialize it -- has animated Western thought for more than two millennia. Plato's Forms, Aristotle's genus-and-differentia, Porphyry's Tree, Kant's a-priori categories, Christopher Alexander's pattern language, the Gang of Four's software patterns, and contemporary Ontology Design Patterns form a continuous arc that ontology engineering now renders machine-executable.

From the **Executable Knowledge Architecture (EKA)** perspective ([Section 20.10](#2010-eka-perspective----stage-3-strengthens--and-prepares)), Stage 3 simultaneously strengthens the **Knowledge Graph layer ($K$)** -- making it composable, modular, and interoperable -- and prepares the **Governance layer $\Gamma$**.
...
Finally, [Section 20.11](#2011-engineering-guidelines-for-knowledge-reuse) distilled eight practical engineering guidelines:
...
Through **Exercise 16** and **Exercise 17**, we have practiced the pattern of **clone before create** -- reusing validated semantic knowledge while introducing only necessary variation.

We have also begun to recognize the governance implications of reuse:

> the need to document semantic lineage, validate after every reuse, and design for future governance.
...
### 20.14.1 From Reuse to Governance
...
### 20.14.2 What Semantic Governance Entails

**Stage 4 -- Semantic Governance** is the discipline of maintaining semantic integrity across an evolving knowledge ecosystem. It ensures that reusable assets remain trustworthy over time, and that the knowledge infrastructure built upon them does not decay.
...
### 20.14.3 The SDC Model as Governance Infrastructure
...
The technical architecture collapses traditional attack surfaces from hundreds of API endpoints to just two -- `/schema` and `/ingest` -- because the governance rules travel with the payload, not alongside it.
...
| **23** | Stage 6 -- Semantic Reasoning | Deriving new knowledge through automated inference |
...
> **Reuse is not merely a modeling technique. It is the engineering practice that makes governance, validation, reasoning, and execution <u>scalable</u>.**

### 20.14.5 The Arc of the Lifecycle
...
[^1]: NIEM, now called NIEMOpen, formally known as the National Information Exchange Model, https://en.wikipedia.org/wiki/NIEMOpen
[^2]: Data Physics: https://axiussdc.substack.com/p/the-physics-of-meaning-why-we-stopped