...
**OWL reasoning** answers: *What else is true?* (Note: the reasoner does not directly write inferred triples back into the original OWL file or persistent triple store, unless you run Drools and write to OWL manually in Protégé.)
